...
<!-- Paper 1 -->
<div class="pub-card"><div class="pub-img-col"><img src="/images/att_decay_by_distance.png" alt="Result: Mining Discovered on Malaria Incidence (per 1,000)"><p class="pub-img-caption">Result: Mining Discovered on Malaria Incidence (per 1,000)</p></div><div class="pub-content-col"><div class="pub-badges"><span class="pub-badge pub-badge-blue">On-going</span><span class="pub-badge pub-badge-teal">Solo-authored</span></div><p class="pub-title">Beyond the Mine Gate: Mining, Deforestation, and Malaria in Africa <a href="https://drive.google.com/file/d/1h63i-3y7F_S4xyjfb0YJR7aM5O7SGFb9/view?usp=sharing" target="_blank" rel="noopener">[Slides]</a>  </p><p class="pub-abstract collapsed" id="abs-1">This paper estimates the health costs of industrial mining in Africa. Using 1.6 million grid-cell-year observations from 45 sub-Saharan African countries
and a staggered difference-in-differences design, I show that mine discoveries increase malaria incidence, prevalence, and mortality. The effects are largest 10--50 km from mines, indicating substantial spatial spillovers. Over a 15-year mine horizon, mining adds 459 malaria cases per 1,000 people, 92.6 percentage points of prevalence, and 143 deaths per 100,000 in the average treated grid cell.
 Deforestation is the main mechanism and explains the especially large effects of artisanal gold
mining. Electrification partly offsets these costs but mainly benefits richer households, leaving poorer households exposed to the disease burden.</p><button class="pub-toggle" onclick="pubToggle('abs-1',this)" aria-expanded="false"><svg viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg> Read abstract</button></div></div>
